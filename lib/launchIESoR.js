...
//grab a websocket server
// var wsServer = require('ws').Server;
// var path = require('path');
// var childSimProcess = require('child_process').fork( path.resolve(__dirname, './direct-simulation/direct-simulation.js'));
